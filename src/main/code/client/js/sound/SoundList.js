...
define(["game/GameConfiguration"],function(gameConfig){
    ...
    return {
        ...
        MACHINE_ROT_SWELL_1:{folder:"machines",file:"machine_rot_swell_1", gain:0.1,   track:TRACKS.game, options:{preload:true}},
        MACHINE_ROT_SWELL_2:{folder:"machines",file:"machine_rot_swell_2", gain:0.15,  track:TRACKS.game, options:{preload:true}},
        MACHINE_ROT_SWELL_3:{folder:"machines",file:"machine_rot_swell_3", gain:0.2,   track:TRACKS.game, options:{preload:true}},
        MACHINE_ROT_LOOP_1: {folder:"machines",file:"machine_rot_loop_1" , gain:0.2,   track:TRACKS.game, options:{preload:true}},
        HELICOPTER_SWELL_1:{folder:"helicopter",file:"helicopter_swell_1", gain:0.3,   track:TRACKS.game, options:{preload:true}},
        HELICOPTER_SWELL_2:{folder:"helicopter",file:"helicopter_swell_2", gain:0.3,   track:TRACKS.game, options:{preload:true}},

        ATC_CHATTER_1   :   {folder:"chatter" ,file:"atc_chatter_1"  , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_2   :   {folder:"chatter" ,file:"atc_chatter_2"  , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_3   :   {folder:"chatter" ,file:"atc_chatter_3"  , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_4   :   {folder:"chatter" ,file:"atc_chatter_4"  , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_5   :   {folder:"chatter" ,file:"atc_chatter_5"  , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_6   :   {folder:"chatter" ,file:"atc_chatter_6"  , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_7   :   {folder:"chatter" ,file:"atc_chatter_7"  , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_8   :   {folder:"chatter" ,file:"atc_chatter_8"  , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_9   :   {folder:"chatter" ,file:"atc_chatter_9"  , gain:0.3,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_10  :   {folder:"chatter" ,file:"atc_chatter_10" , gain:0.3,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_11  :   {folder:"chatter" ,file:"atc_chatter_11" , gain:0.3,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_12   :  {folder:"chatter" ,file:"atc_chatter_12" , gain:0.3,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_13   :  {folder:"chatter" ,file:"atc_chatter_13" , gain:0.3,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_14   :  {folder:"chatter" ,file:"atc_chatter_14" , gain:0.3,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_15   :  {folder:"chatter" ,file:"atc_chatter_15" , gain:0.4,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_16   :  {folder:"chatter" ,file:"atc_chatter_16" , gain:0.4,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_17   :  {folder:"chatter" ,file:"atc_chatter_17" , gain:0.4,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_18   :  {folder:"chatter" ,file:"atc_chatter_18" , gain:0.4,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_19   :  {folder:"chatter" ,file:"atc_chatter_19" , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_20   :  {folder:"chatter" ,file:"atc_chatter_20" , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        ATC_CHATTER_21   :  {folder:"chatter" ,file:"atc_chatter_21" , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},


        MILITARY_CHATTER_1   :   {folder:"chatter" ,file:"military_chatter_1"  , gain:0.1,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_2   :   {folder:"chatter" ,file:"military_chatter_2"  , gain:0.1,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_3   :   {folder:"chatter" ,file:"military_chatter_3"  , gain:0.1,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_4   :   {folder:"chatter" ,file:"military_chatter_4"  , gain:0.1,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_5   :   {folder:"chatter" ,file:"military_chatter_5"  , gain:0.1,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_6   :   {folder:"chatter" ,file:"military_chatter_6"  , gain:0.1,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_7   :   {folder:"chatter" ,file:"military_chatter_7"  , gain:0.1,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_8   :   {folder:"chatter" ,file:"military_chatter_8"  , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_9   :   {folder:"chatter" ,file:"military_chatter_9"  , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_10  :   {folder:"chatter" ,file:"military_chatter_10" , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_11  :   {folder:"chatter" ,file:"military_chatter_11" , gain:0.2,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_12   :  {folder:"chatter" ,file:"military_chatter_12" , gain:0.3,   track:TRACKS.ambient, options:{preload:true}},
        MILITARY_CHATTER_13   :  {folder:"chatter" ,file:"military_chatter_13" , gain:0.3,   track:TRACKS.ambient, options:{preload:true}},

        JET_LOOP_LOUD_1 :   {folder:"jet"     ,file:"jet_loop_loud_1", gain:0.3,   track:TRACKS.game, options:{preload:true}},
        JET_LOOP_LOUD_2 :   {folder:"jet"     ,file:"jet_loop_loud_2", gain:0.4,   track:TRACKS.game, options:{preload:true}},
        ...
        JET_TAKEOFF_1    :  {folder:"jet"     ,file:"jet_takeoff_1"   ,gain:0.1,   track:TRACKS.game, options:{preload:true}},
        JET_TAKEOFF_2    :  {folder:"jet"     ,file:"jet_takeoff_2"   ,gain:0.2,   track:TRACKS.game, options:{preload:true}},
        JET_TAKEOFF_3    :  {folder:"jet"     ,file:"jet_takeoff_3"   ,gain:0.3,   track:TRACKS.game, options:{preload:true}},
        ...
        MUSIC_INTRO_ANT :   {folder:"music"   ,file:"intro_ant_faded", gain:1,     track:TRACKS.music,   options:{preload:true}},
