    ...
    function(
        ...
        */
			...
			var effectData = {
                ...
                count:20*state,
                alpha: [[0.1, 1], [0.3,0.7], [1, 0]],
                growth: [[0, 1], [0.1,4], [0.9, -11]],
                size:[fxGrow*1.3, fxGrow*1.4],
                "growthFactor":[1, 3.2],
                "stretch":1,
                "strength":5*state,
                "spread":0.03,
			...
			if (state > 0.90) {
				...
				var effectData = {
                    ...
                    opacity:[0.3, 0.8],
                    alpha: [[0, 1], [0.1,0.7],[0.5,0.2], [1, 0]],
                    growth: [[0, 1], [0.35, 51.2], [1, -30.2]],
                    size:[fxGrow, fxGrow+0.1],
                    count:20*state*state*state,
                    "growthFactor":[1, 1.2],
                    "stretch":1,
                    "strength":10,
                    "spread":0.23,
