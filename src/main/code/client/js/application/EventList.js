...
define(function() {
    ...
    return {
        ...
        STOP_SOUND:{type:"STOP_SOUND", eArgs:{playId:"", fadeTime:0}},
        ONESHOT_SOUND:{type:"ONESHOT_SOUND", eArgs:{soundData:{}, playId:"", fadeTime:0, callback:func}},
        START_SOUND_LOOP:{type:"START_SOUND_LOOP", eArgs:{soundData:{}, loopId:"", fadeTime:0, callback:function(){}}},
        STOP_SOUND_LOOP:{type:"STOP_SOUND_LOOP", eArgs:{loopId:"", fadeTime:0}},
